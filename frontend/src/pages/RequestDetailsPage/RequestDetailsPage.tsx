      ...
      <div className="flex items-center">
        <TabsList>
          ...
          <TabsTrigger value="issues" className="relative">
            Issues
            {traceId && (
              <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-gray-900 rounded-full -top-2 -end-2  empty:hidden">
