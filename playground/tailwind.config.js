  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "fp-status": {
          success: "hsl(var(--fp-status-success))",
          warning: "hsl(var(--fp-status-warning))",
          error: "hsl(var(--fp-status-error))",
          "success-fg": "hsl(var(--fp-status-success-fg))",
          "warning-fg": "hsl(var(--fp-status-warning-fg))",
          "error-fg": "hsl(var(--fp-status-error-fg))",
        },
        info: "hsl(var(--info))",
