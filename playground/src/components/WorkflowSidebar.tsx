              ...
              <div className="grid gap-2">
                {Object.entries(groupedRoutes || {}).map(([tag, routes]) => (
                  <div key={tag} className="mb-4">
                    <h3 className="mb-2 text-xs font-medium text-muted-foreground">{tag}</h3>
                    <div className="grid gap-1">
                      {routes.map((route, index) => (
                        ...
                        >
                          <span className={cn("font-mono font-medium w-14", methodColors[route.method] || "text-gray-500")}>
                            {route.method}
                          </span>
