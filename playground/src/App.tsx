      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl font-bold mb-4 text-foreground">Geese API</h1>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <Button variant="outline" className="gap-2 bg-accent text-accent-foreground border-accent hover:bg-accent/80">
                  Shell
                </Button>
