...
// .wrangler/tmp/bundle-4NqlBo/checked-fetch.js
...
var Pn = T((Tt) => {
	...
	Tt.read = (r, e, t, n, i) => {
		...
		if (s === 0) s = 1 - h;
			...
			if (s === c) return o ? Number.NaN : (C ? -1 : 1) * (1 / 0);
			(o = o + Math.pow(2, n)), (s = s - h);
		}
		return (C ? -1 : 1) * o * Math.pow(2, s - n);
	};
	Tt.write = (r, e, t, n, i, s) => {
		var o,
			u,
			c,
			h = s * 8 - i - 1,
					...
					: ((o = Math.floor(Math.log(e) / Math.LN2)),
						...
						o + y >= l
							...
							: o + y >= 1
								...
								: ((u = e * Math.pow(2, y - 1) * Math.pow(2, i)), (o = 0)));
			i >= 8;
...
var $n = T((Le) => {
	...
	a(yo, "alloc");
	f.alloc = (r, e, t) => yo(r, e, t);
	function Ft(r) {
		return Dn(r), fe(r < 0 ? 0 : Mt(r) | 0);
	}
	a(Ft, "allocUnsafe");
	f.allocUnsafe = (r) => Ft(r);
	f.allocUnsafeSlow = (r) => Ft(r);
	function mo(r, e) {
	...
	a(mo, "fromString");
	function Bt(r) {
		const e = r.length < 0 ? 0 : Mt(r.length) | 0,
			t = fe(e);
	...
	a(bo, "SlowBuffer");
	f.isBuffer = a(
		(e) => e != null && e._isBuffer === true && e !== f.prototype,
		"isBuffer",
	);
	f.compare = a((e, t) => {
		if (
				...
				switch (u) {
					...
					case 3:
						(c = r[i + 1]),
							...
							(c & 192) === 128 &&
								(h & 192) === 128 &&
								((y = ((s & 15) << 12) | ((c & 63) << 6) | (h & 63)),
								y > 2047 && (y < 55296 || y > 57343) && (o = y));
						break;
					case 4:
						(c = r[i + 1]),
							(h = r[i + 2]),
	...
	function Io(r) {
		...
		let t = "",
			n = 0;
		while (n < e) t += String.fromCharCode.apply(String, r.slice(n, (n += Rn)));
		return t;
	}
	...
	function Wn(r, e, t, n, i) {
		return (
			(e = +e),
			(t = t >>> 0),
			i || Qn(r, e, t, 4, 34028234663852886e22, -34028234663852886e22),
	...
	function jn(r, e, t, n, i) {
		return (
			(e = +e),
			(t = t >>> 0),
			i || Qn(r, e, t, 8, 17976931348623157e292, -17976931348623157e292),
	...
	f.prototype.fill = a(function (e, t, n, i) {
		...
		if (typeof e == "number") for (s = t; s < n; ++s) this[s] = e;
			...
			const o = f.isBuffer(e) ? e : f.from(e, i),
				u = o.length;
			if (u === 0)
				throw new TypeError(
	...
	function Mo(r) {
		if (((r = r.split("=")[0]), (r = r.trim().replace(Fo, "")), r.length < 2))
			return "";
...
var we = T((Jc, Ut) => {
	...
	Re && typeof Re.ownKeys == "function"
		...
		: Object.getOwnPropertySymbols
			...
			: (ot = a((e) => Object.getOwnPropertyNames(e), "ReflectOwnKeys"));
	function No(r) {
		console && console.warn && console.warn(r);
	}
	a(No, "ProcessEmitWarning");
	var zn = Number.isNaN || a((e) => e !== e, "NumberIsNaN");
	function L() {
		L.init.call(this);
	}
	a(L, "EventEmitter");
	...
	L.prototype.emit = a(function (e) {
		...
		if (typeof c == "function") Vn(c, this, t);
			...
			for (var h = c.length, l = ti(c, h), n = 0; n < h; ++n) Vn(l[n], this, t);
		return true;
	}, "emit");
	function Zn(r, e, t, n) {
		var i, s, o;
	...
	L.listenerCount = (r, e) =>
		typeof r.listenerCount == "function" ? r.listenerCount(e) : ei.call(r, e);
...
function Ge(r) {
	let e = 1779033703,
		...
		W = a(() => {
			...
			for (let R = 16; R < 64; R++) {
				const G = x(C[R - 15], 7) ^ x(C[R - 15], 18) ^ (C[R - 15] >>> 3),
	...
	if (r === "md5")
		return {
			update: a(
				(e) => ({
					digest: a(
						() => (typeof e == "string" ? $e.hashStr(e) : $e.hashByteArray(e)),
						"digest",
					),
				}),
				"update",
...
var Wt = T((yh, oi) => {
	...
	oi.exports = {
		create: a(
			(r, e) => ({ parse: a(() => Yo.parse(r, e), "parse") }),
			"create",
		),
	};
});
var ci = T((wh, ui) => {
	...
	ui.exports = a((e) => {
		...
		var s = Number.parseInt(t[2], 10) - 1,
			...
			h = Number.parseInt(t[6], 10),
			l = t[7];
		l = l ? 1e3 * Number.parseFloat(l) : 0;
		var y,
			x = ra(e);
		return (
			x != null
				...
				: ((y = new Date(i, s, o, u, c, h, l)), jt(i) && y.setFullYear(i)),
			y
		);
	}, "parseDate");
	function ta(r) {
...
var di = T((_h, pi) => {
	...
	var Ht = "([+-]?\\d+)",
		...
		fa = Ht + "\\s+days?",
		pa = "([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?",
		da = new RegExp([ha, la, fa, pa].map((r) => "(" + r + ")?").join("\\s*")),
		fi = {
			years: 2,
			months: 4,
			days: 6,
	...
	function ga(r) {
		...
		var e = da.exec(r),
			t = e[8] === "-";
		return Object.keys(fi).reduce((n, i) => {
			var s = fi[i],
				o = e[s];
			return (
				!o ||
					((o = i === "milliseconds" ? ma(o) : Number.parseInt(o, 10)), !o) ||
...
var Ei = T((Bh, vi) => {
	...
	var xa = a((r) => {
			if (!r) return null;
			var e = Ke.create(r, (t) => (t !== null && (t = zt(t)), t));
			return e.parse();
		}, "parsePointArray"),
		$t = a((r) => {
			if (!r) return null;
		...
		Vt = a((r) => {
			if (!r) return null;
			var e = Ke.create(r, (t) => (t !== null && (t = ct(t)), t));
			return e.parse();
		}, "parseDateArray"),
		va = a((r) => {
			if (!r) return null;
			var e = Ke.create(r, (t) => (t !== null && (t = wi(t)), t));
			return e.parse();
		}, "parseIntervalArray"),
		Ea = a((r) => (r ? Ve.parse(r, ht(bi)) : null), "parseByteAArray"),
		Kt = a((r) => Number.parseInt(r, 10), "parseInteger"),
		xi = a((r) => {
			var e = String(r);
			return /^\d+$/.test(e) ? e : r;
		}, "parseBigInteger"),
		gi = a((r) => (r ? Ve.parse(r, ht(JSON.parse)) : null), "parseJsonArray"),
		zt = a(
			(r) =>
				r[0] !== "("
					? null
...
var Bi = T((kh, Pi) => {
	...
	var Ia = Ai(),
		...
		Ta = a(
			(r) => (F(r, 1) == 1 ? -1 * (F(r, 15, 1, true) + 1) : F(r, 15, 1)),
			"parseInt16",
		),
		Ci = a(
			(r) => (F(r, 1) == 1 ? -1 * (F(r, 31, 1, true) + 1) : F(r, 31, 1)),
			"parseInt32",
		),
		Pa = a((r) => Ti(r, 23, 8), "parseFloat32"),
		Ba = a((r) => Ti(r, 52, 11), "parseFloat64"),
		La = a((r) => {
			var e = F(r, 16, 32);
			if (e == 49152) return Number.NaN;
			for (
		...
		ze = a((r) => {
			...
			var u = a(function (h) {
					...
					if (h == 25)
						return (
							(y = r.toString(this.encoding, i >> 3, (i += l << 3) >> 3)), y
						);
		...
		Ra = a((r) => r.toString("utf8"), "parseText"),
		Fa = a((r) => (r === null ? null : F(r, 8) > 0), "parseBool"),
		Ma = a((r) => {
			r(20, Ia),
				r(21, Ta),
				r(23, Ci),
...
var Xe = T((Hh, Yt) => {
	...
	Yt.exports.__defineSetter__("parseInt8", (r) => {
		Me.setTypeParser(20, "text", r ? Me.getTypeParser(23, "text") : Qa),
			Me.setTypeParser(1016, "text", r ? Me.getTypeParser(1007, "text") : Wa);
	});
});
var et = T(($h, Di) => {
	p();
	...
	var Zt = a(
			(r) => ja.createHash("md5").update(r, "utf-8").digest("hex"),
			"md5",
		),
		Ya = a((r, e, t) => {
			var n = Zt(e + r),
	...
	Di.exports = {
		prepareValue: a((e) => lt2(e), "prepareValueWrapper"),
...
var qi = T((zh, Ni) => {
	...
	function Za(r) {
		...
		const e = Jt.randomBytes(18).toString("base64");
		return {
...
`);
	...
	pe.exports.usePgPass = (r, e) =>
		Object.prototype.hasOwnProperty.call(m.env, "PGPASSWORD")
			? false
			: pt
				? true
				: ((e = e || "<unkn>"),
					Su(r.mode)
						...
						: (ur('WARNING: password file "%s" is not a plain file', e),
							false));
	var vu = (pe.exports.match = (r, e) =>
		ke
			.slice(0, -1)
			.reduce(
				(t, n, i) =>
					i == 1 && Number(r[n] || yu) === Number(e[n])
						? t && true
						: t && (e[n] === "*" || e[n] === r[n]),
				true,
			));
...
var ns = T((Sl, rs) => {
	...
	function dr(r) {
		...
		switch (
			...
			t.sslrootcert && (t.ssl.ca = pr.readFileSync(t.sslrootcert).toString()),
			t.sslmode)
		) {
			case "disable": {
				t.ssl = false;
		...
		mr = class mr {
			constructor(e) {
				(e = typeof e == "string" ? is2(e) : e || {}),
					...
					(this.port = Number.parseInt($("port", e), 10)),
					(this.host = $("host", e)),
			...
			getLibpqConnectionString(e) {
				...
				if (
					...
					this.replication && t.push("replication=" + Ue(this.replication)),
				...
				this.client_encoding &&
					...
					Tu.lookup(this.host, (i, s) =>
						i
							? e(i, null)
							: (t.push("hostaddr=" + Ue(s)), e(null, t.join(" "))),
					);
			}
		};
	...
	(Fu = a((r) => r.replace(/^[^.]+\./, "api."), "transformHost")),
		(E = class E2 extends ds.EventEmitter {
			...
			connect(t, n, i) {
				...
				try {
					const h = (this.useSecureWebSocket ? "wss:" : "ws:") + "//" + u;
					...
					const l = (this.useSecureWebSocket ? "https:" : "http:") + "//" + u;
			...
			async startTls(t) {
				...
				this.tlsState = 1;
				const n = this.subtls.TrustedCert.fromPEM(this.rootCerts),
...
var ws = T((St) => {
	...
	var Jr = ms(),
		...
		Mu = a((r) => {
			...
			for (const n of Object.keys(r)) M.addCString(n).addCString(r[n]);
		...
		Uu = a(
			(r, e) => (
				M.addCString(r).addInt32(d.byteLength(e)).addString(e), M.flush(112)
			),
			"sendSASLInitialResponseMessage",
		),
		Ou = a((r) => M.addString(r).flush(112), "sendSCRAMClientFinalMessage"),
			...
			for (let t = 0; t < r.length; t++) {
				...
				n == null
					...
					: n instanceof d
						...
						: (M.addInt16(0), Oe.addInt32(d.byteLength(n)), Oe.addString(n));
			}
		}, "writeValues"),
		Wu = a((r = {}) => {
			const e = r.portal || "",
		...
		Ku = a(
			(r) =>
				r.name ? Xr(68, `${r.type}${r.name || ""}`) : r.type === "P" ? $u : Vu,
			"describe",
		),
		zu = a((r) => {
			...
			parse(e, t) {
				...
				while (i + Ss <= n) {
					const s = this.buffer[i],
						...
						u = rn + o;
					if (u + i <= n) {
						const c = this.handlePacket(i + Ss, s, o, this.buffer);
						t(c), (i += u);
					} else break;
				}
				i === n
...
var on = T((Se) => {
	...
	Object.defineProperty(Se, "DatabaseError", {
		enumerable: true,
		get: a(() => oc.DatabaseError, "get"),
	});
	var ac = ws();
	Object.defineProperty(Se, "serialize", {
		enumerable: true,
		get: a(() => ac.serialize, "get"),
	});
	var uc = vs();
	function cc(r, e) {
		const t = new uc.Parser();
		return (
	...
	var yc = we().EventEmitter,
		...
		ln = class ln extends yc {
			...
			_handleAuthMD5Password(e) {
				this._checkPgPass(() => {
					const t = mc.postgresMd5PasswordHash(
						this.user,
						this.password,
						e.salt,
					);
...
var Ms = T((uf, Fs) => {
	...
	var mn = class mn extends vc {
		...
		_remove(e) {
			const t = Rs(this._idle, (n) => n.client === e);
				...
				t.connect((o) => {
					if ((i && clearTimeout(i), t.on("error", n), o))
						this.log("client failed to connect", o),
							...
							this._pulseQueue(),
							e.timedOut || e.callback(o, void 0, Ls);
					else {
						if (
							...
							const u = setTimeout(() => {
								this.log("ending client due to expired lifetime"),
									...
									this._idle.findIndex((h) => h.client === t) !== -1 &&
										this._acquireClient(t, new Ne((h, l, y) => y()), n, false);
...
function zs(
	...
	a(X, "resolve"),
		(X.transaction = async (A, w) => {
			...
			const P = A.map((k) => k.parameterizedQuery),
				V = A.map((k) => k.opts ?? {});
			return de(P, V, w);
		});
	async function de(A, w, P) {
		...
		P !== void 0 &&
			...
			P.fullResults !== void 0 && (G = P.fullResults),
			P.isolationLevel !== void 0 && (he = P.isolationLevel),
			P.readOnly !== void 0 && (ye = P.readOnly),
			P.deferrable !== void 0 && (ve = P.deferrable)),
			w !== void 0 &&
				!Array.isArray(w) &&
				w.fetchOptions !== void 0 &&
		...
		Array.isArray(A) &&
			(he !== void 0 && (me["Neon-Batch-Isolation-Level"] = he),
			ye !== void 0 && (me["Neon-Batch-Read-Only"] = String(ye)),
			ve !== void 0 && (me["Neon-Batch-Deferrable"] = String(ve)));
		let se;
		try {
			se = await (k ?? fetch)(j, {
				method: "POST",
			...
			const O = new Ce(`Error connecting to database: ${oe.message}`);
			throw ((O.sourceError = oe), O);
		}
		if (se.ok) {
			const oe = await se.json();
			if (Array.isArray(A)) {
				const O = oe.results;
				if (!Array.isArray(O))
			...
			if (oe === 400) {
				const O = await se.json(),
					K = new Ce(O.message);
				for (const le of Nc) K[le] = O[le] ?? void 0;
				throw K;
			} else {
				const O = await se.text();
...
function Vs(
	...
	const s = r.fields.map((c) => c.name),
		o = r.fields.map((c) => xe.types.getTypeParser(c.dataTypeID)),
		u =
			e === true
				? r.rows.map((c) => c.map((h, l) => (h === null ? null : o[l](h))))
				: r.rows.map((c) =>
						Object.fromEntries(
...
var vn = class vn2 extends Ct.Client {
	...
	connect(t) {
		...
		if ((u && h.on("connect", () => h.stream.emit("data", "S")), c)) {
			...
			const l = this.ssl ? "sslconnect" : "connect";
			h.on(l, () => {
	...
	async _handleAuthSASLContinue(t) {
		...
		let l = Number.parseInt(h, 10),
			...
			W = new Uint8Array(
				await g.subtle.sign("HMAC", B, d.concat([y, d.from([0, 0, 0, 1])])),
			),
			X = W;
		...
		const ve = await g.subtle.importKey(
				"raw",
				A,
				{ name: "HMAC", hash: { name: "SHA-256" } },
				false,
...
var En = class En2 extends Ct.Pool {
	...
	query(t, n, i) {
		...
		const s = Qc(this.Promise, i);
		i = s.callback;
		try {
			const o = new Zs.default(this.options),
				u = encodeURIComponent,
				c = encodeURI,
				h = `postgresql://${u(o.user)}:${u(o.password)}@${u(o.host)}/${c(
					o.database,
				)}`,
...
var PrimaryKey = class {
	...
	getName() {
		return (
			this.name ??
			`${this.table[PgTable.Symbol.Name]}_${this.columns
...
_a40 = entityKind;
__publicField(PgDeleteBase, _a40, "PgDelete");
...
_a41 = entityKind;
__publicField(PgInsertBuilder, _a41, "PgInsertBuilder");
var _a42;
...
_a42 = entityKind;
__publicField(PgInsertBase, _a42, "PgInsert");
...
_a50 = entityKind;
__publicField(PgJsonBuilder, _a50, "PgJsonBuilder");
var _a51;
...
_a51 = entityKind;
__publicField(PgJson, _a51, "PgJson");
...
_a52 = entityKind;
__publicField(PgJsonbBuilder, _a52, "PgJsonbBuilder");
var _a53;
...
_a53 = entityKind;
__publicField(PgJsonb, _a53, "PgJsonb");
function jsonb(name) {
...
_a54 = entityKind;
__publicField(PgNumericBuilder, _a54, "PgNumericBuilder");
var _a55;
...
_a55 = entityKind;
__publicField(PgNumeric, _a55, "PgNumeric");
...
_a56 = entityKind;
__publicField(PgSerialBuilder, _a56, "PgSerialBuilder");
var _a57;
...
_a57 = entityKind;
__publicField(PgSerial, _a57, "PgSerial");
...
_a68 = entityKind;
__publicField(PgViewBase, _a68, "PgViewBase");
				...
				if (is(table2, PgTable)) {
					...
					joinsArray.push(
						sql`${sql.raw(joinMeta.joinType)} join${lateralSql} ${
							tableSchema ? sql`${sql.identifier(tableSchema)}.` : void 0
					...
					joinsArray.push(
						sql`${sql.raw(joinMeta.joinType)} join${lateralSql} ${
							viewSchema ? sql`${sql.identifier(viewSchema)}.` : void 0
					...
					joinsArray.push(
						sql`${sql.raw(joinMeta.joinType)} join${lateralSql} ${table2} on ${
							joinMeta.on
						}`,
					);
				}
		...
		if (nestedQueryRelation) {
			let field = sql`json_build_array(${sql.join(
				selection.map(({ field: field2, tsKey, isJson }) =>
					isJson
						? sql`${sql.identifier(`${tableAlias}_${tsKey}`)}.${sql.identifier(
								"data",
							)}`
...
_a69 = entityKind;
__publicField(PgDialect, _a69, "PgDialect");
...
_a70 = entityKind;
__publicField(SelectionProxyHandler, _a70, "SelectionProxyHandler");
...
_a72 = entityKind;
__publicField(PgSelectBuilder, _a72, "PgSelectBuilder");
var _a73;
...
_a73 = entityKind;
__publicField(PgSelectQueryBuilderBase, _a73, "PgSelectQueryBuilder");
var _a74;
...
_a74 = entityKind;
__publicField(PgSelectBase, _a74, "PgSelect");
...
_a75 = entityKind;
__publicField(QueryBuilder, _a75, "PgQueryBuilder");
...
_a76 = entityKind;
__publicField(PgRefreshMaterializedView, _a76, "PgRefreshMaterializedView");
...
_a77 = entityKind;
__publicField(PgUpdateBuilder, _a77, "PgUpdateBuilder");
var _a78;
...
_a78 = entityKind;
__publicField(PgUpdateBase, _a78, "PgUpdate");
...
_a79 = entityKind;
__publicField(RelationalQueryBuilder, _a79, "PgRelationalQueryBuilder");
var _a80;
...
_a80 = entityKind;
__publicField(PgRelationalQuery, _a80, "PgRelationalQuery");
...
_a81 = entityKind;
__publicField(PgRaw, _a81, "PgRaw");
...
_a82 = entityKind;
__publicField(PgDatabase, _a82, "PgDatabase");
...
_a83 = entityKind;
__publicField(PgPreparedQuery, _a83, "PgPreparedQuery");
var _a84;
var PgSession = class {
	constructor(dialect) {
		this.dialect = dialect;
...
_a84 = entityKind;
__publicField(PgSession, _a84, "PgSession");
var _a85;
...
_a85 = entityKind;
__publicField(PgTransaction, _a85, "PgTransaction");
...
_a86 = entityKind;
__publicField(NeonHttpPreparedQuery, _a86, "NeonHttpPreparedQuery");
var _a87;
...
_a87 = entityKind;
__publicField(NeonHttpSession, _a87, "NeonHttpSession");
var _a88;
...
_a88 = entityKind;
__publicField(NeonTransaction, _a88, "NeonHttpTransaction");
...
_a89 = entityKind;
__publicField(NeonHttpDriver, _a89, "NeonDriver");
var _a90;
...
_a90 = entityKind;
__publicField(NeonHttpDatabase, _a90, "NeonHttpDatabase");
...
function polyfillWaitUntil(ctx) {
	if (typeof ctx.waitUntil !== "function") {
		if (!Array.isArray(ctx.__waitUntilPromises)) {
			ctx.__waitUntilPromises = [];
		}
		ctx.waitUntil = function waitUntil(promise) {
		...
		for (const level of RECORDED_CONSOLE_METHODS) {
			...
			console[level] = (originalMessage, ...args) => {
				...
				if (typeof message !== "string" && message.name === "NeonDbError") {
					message = JSON.stringify(neonDbErrorToJson(message));
				}
...
function extractCallerLocation(callerLine) {
	if (!callerLine) {
		return null;
	}
	const match = callerLine.match(/at (.*?) \(?(.*?):(\d+):(\d+)\)?$/);
	if (match) {
		const [_2, method, file, line, column] = match;
		return {
			method,
			file,
			line,
...
// src/mizu/mizu-hono-logger.ts
var humanize = (times) => {
	const [delimiter, separator] = [",", "."];
	const orderTimes = times.map((v2) =>
		// biome-ignore lint/style/useTemplate: copied from hono source
		v2.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + delimiter),
	);
...
function logReq(fn, method, headers, path, env, params, query) {
	const out = {
		lifecycle: "request",
		method,
		headers,
...
function logRes(
	...
	const out = {
		...
		handlerType,
		// Unsure if this is useful... or how
...
var logger = (fn = console.log, errFn = console.error) => {
	return async function logger2(c, next) {
		...
		const matchedRoute = c.req.matchedRoutes.find((route) => {
...
// src/index.ts
var BugError = class extends Error {
	constructor(message) {
		super(message);
		this.name = "BugError";
...
app.use(async (c, next) => {
	...
	const teardown = Mizu.init(config, ctx);
	await next();
	teardown();
	if (c.error) {
	} else {
...
app.get("/bugs", async (c) => {
	...
	const bugs2 = await db.select().from(bugs);
	return c.json({ bugs: bugs2 });
});
...
app.get("/bad-insert-neon", async (c) => {
	const sql2 = zs(c.env.DATABASE_URL);
	const insertResponse = await sql2(
		"insert into bugs (name, description, price, attributes) values ($1, $2, $3)",
		["Mantis", "...", 10.99, { pincers: true }],
	);
	return c.text("Hello Hono!");
});
...
// .wrangler/tmp/bundle-4NqlBo/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4NqlBo/middleware-loader.entry.ts
...
function wrapExportedHandler(worker) {
	...
	const fetchDispatcher = (request, env, ctx) => {
