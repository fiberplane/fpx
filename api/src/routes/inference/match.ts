 ...
 *
 * @NOTE - Assumes all routes are currently registered
 */
export function findAllSmartRouterMatches(
  ...
  // HACK - We need to be able to associate route handlers back to the AppRoute definition
  const functionHandlerLookupTable: Map<() => void, AppRoute> = new Map();
