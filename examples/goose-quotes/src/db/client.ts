...
export const searchGeese = measure(
  "searchGeese",
  async (db: ReturnType<typeof drizzle>, name: string) => {
...
export const createGoose = measure(
  "createGoose",
  async (
...
export const getGooseById = measure(
  "getGooseById",
...
export const getFlockLeaders = measure(
  "getFlockLeaders",
  async (db: ReturnType<typeof drizzle>) => {
...
export const updateGooseName = measure(
  "updateGooseName",
  async (db: ReturnType<typeof drizzle>, id: number, name: string) => {
...
export const getGeeseByLanguage = measure(
  "getGeeseByLanguage",
...
export const updateGooseMotivations = measure(
  "updateGooseMotivations",
  async (db: ReturnType<typeof drizzle>, id: number, motivations: string) => {
...
export const updateGooseAvatar = measure(
  "updateGooseAvatar",
  async (db: ReturnType<typeof drizzle>, id: number, avatarKey: string) => {
...
export const updateGoose = measure(
  "updateGoose",
  async (
    db: ReturnType<typeof drizzle>,
    id: number,
