...
import video from "../../assets/blog/2024-11-27-client-side-guide.mov";
...
<Aside>
  ...
  rendering only, check out the [example on GitHub](https://github.com/oscarvz/cf-workers-hono-client-side).
</Aside>
...
You can now push your app with the `deploy` script:
