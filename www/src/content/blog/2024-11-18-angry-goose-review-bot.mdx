---
title: "Angry Goose Pull Request Reviewer"
...
<Aside type="tip" title="Webhooks?">
  Fiberplane has a built-in way to test [webhooks](https://fiberplane.com/docs/features/webhooks/).
</Aside>

Most of the heavy lifting in done in the POST `/api/pull-requests` endpoint, that listens for incoming pull requests and initiates the review process.
