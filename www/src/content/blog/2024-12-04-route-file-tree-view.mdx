...
TL;DR: file tree view is a toggle in the "Routes" left sidebar that allows you to better see your API routes in the Fiberplane Studio as they are organized in your project files.
...
- static code analysis to map the routes to the correct files.
