...
To implement retries, we can use a message broker and it's consumer. Cloudflare provides [Queues](https://developers.cloudflare.com/queues/reference/how-queues-works/) to facilitate this approach.
Let's use a Cloudflare queue to handles messages between our sign-up and email workers.
