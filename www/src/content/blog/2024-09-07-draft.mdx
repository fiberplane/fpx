...
![Set-up diagramm](@/assets/blog/2024-09-07-img01.png)
...
Our exmaple is build with the [HONC](https://www.honc.dev) stack. The stack consists [Hono.js](https://hono.dev/) as the web framework, a PostgreSQL database ([Neon](https://neon.tech/home)), the ORM [Drizzle](https://orm.drizzle.team/),
...
TODO: IMG/GIF Studio with Webhook
...
This brings everything together on one page and makes it easier to detect errors.
...
Once instrument you can spin up the Fiberplane studio next to your application
