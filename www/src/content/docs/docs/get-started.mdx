...
import getStartedHonoRawCode from "./get-started-cf.example.ts?raw";
import getStartedNodeRawCode from "./get-started-node.example.ts?raw";
...
2. ### Add the Fiberplane Studio client
    ...
    <Aside type="caution">
    Fiberplane Studio and the client library only support Hono on Cloudflare Workers and Node.js. 
    You can upvote support for Bun and Deno on [their respective issues here](https://github.com/fiberplane/fpx/issues/192) to help us prioritize development.
    </Aside>
