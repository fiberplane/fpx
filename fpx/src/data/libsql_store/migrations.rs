...
static MIGRATIONS: Dir<'_> =
    include_dir::include_dir!("$CARGO_MANIFEST_DIR/src/data/libsql_store/migrations");
...
impl LibsqlStore {
    ...
    pub async fn migrate(&self) -> Result<()> {
        ...
        self.migrations_bootstrap(&tx).await?;
    ...
    async fn migrations_bootstrap(&self, tx: &Transaction) -> Result<()> {
